...
![Total](https://img.shields.io/badge/Total-3261-blue?style=flat-square) ![Stars](https://img.shields.io/badge/Stars-3711k%2B-yellow?style=flat-square) ![Today](https://img.shields.io/badge/Today-20-green?style=flat-square) ![Updated](https://img.shields.io/badge/Updated-2026-03-11-orange?style=flat-square)
...
|----------|------:|------:|
| 🏛️ Official & Reference | 216 | ██ 6.6% |
| 🗄️ Database | 114 | █ 3.5% |
| ☁️ Cloud & Infrastructure | 150 | █ 4.6% |
| 🔧 Developer Tools | 645 | ██████ 19.8% |
| 🔍 Search & Web | 290 | ██ 8.9% |
| 📁 File System | 46 | █ 1.4% |
| 🤖 AI & Models | 1062 | ██████████ 32.6% |
| 💬 Communication | 8 | █ 0.2% |
...
|:-:|---------|---:|-------:|-------------|
| 1 | [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 71,315 | +1497 | The agent harness performance optimization system. Skills, i |
| 2 | [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 28,409 | +596 | 🕷️ An adaptive Web Scraping framework that handles everythin |
| 3 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 26,645 | +463 | A cross-platform desktop All-in-One assistant tool for Claud |
| 4 | [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 42,972 | +435 | A curated list of awesome Claude Skills, resources, and tool |
| 5 | [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) | 23,138 | +418 | The Ultimate Collection of 900+ Agentic Skills for Claude Co |
| 6 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | 20,762 | +335 | Agentic IM Chatbot infrastructure that integrates lots of IM |
| 7 | [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 8,301 | +320 | Give your AI agent eyes to see the entire internet. Read & s |
| 8 | [CodeGraphContext/CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | 1,695 | +248 | An MCP server plus a CLI tool that indexes local code into a |
| 9 | [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) | 48,598 | +218 | ⭐AI-driven |
| 10 | [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 20,521 | +189 | 🌊 The leading agent orchestration platform for Claude. Deplo |
| 11 | [n8n-io/n8n](https://github.com/n8n-io/n8n) | 178,660 | +187 | Fair-code workflow automation platform with native AI capabi |
| 12 | [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 562 | +180 | MCP server that indexes your codebase into a persistent know |
| 13 | [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 28,476 | +160 | Chrome DevTools for coding agents |
| 14 | [upstash/context7](https://github.com/upstash/context7) | 48,533 | +154 | Context7 MCP Server -- Up-to-date code documentation for LLM |
| 15 | [microsoft/azure-skills](https://github.com/microsoft/azure-skills) | 177 | +147 | Official agent plugin providing skills and MCP server config |
| 16 | [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | 97,252 | +133 | An open-source AI agent that brings the power of Gemini dire |
| 17 | [superset-sh/superset](https://github.com/superset-sh/superset) | 6,568 | +132 | IDE for the AI Agents Era - Run an army of Claude Code, Code |
| 18 | [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) | 9,764 | +131 | Official, Anthropic-managed directory of high quality Claude |
| 19 | [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) | 80,812 | +116 | Model Context Protocol Servers |
| 20 | [AgriciDaniel/claude-seo](https://github.com/AgriciDaniel/claude-seo) | 2,045 | +107 | Universal SEO skill for Claude Code. 13 sub-skills, 6 subage |

---

## 📁 Categories

- [🏛️ Official & Reference](#official) (216)
- [🗄️ Database](#database) (114)
- [☁️ Cloud & Infrastructure](#cloud) (150)
- [🔧 Developer Tools](#dev-tools) (645)
- [🔍 Search & Web](#web-search) (290)
- [📁 File System](#file-system) (46)
- [🤖 AI & Models](#ai-ml) (1062)
...
<p align="center"><sub>✨ Auto-curated · 2026-03-11 20:12:22</sub></p>
