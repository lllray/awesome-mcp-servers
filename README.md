...
![Total](https://img.shields.io/badge/Total-5122-blue?style=flat-square) ![Stars](https://img.shields.io/badge/Stars-7092k%2B-yellow?style=flat-square) ![Today](https://img.shields.io/badge/Today-4-green?style=flat-square) ![Updated](https://img.shields.io/badge/Updated-2026-08-21-orange?style=flat-square)
...
| 3 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 52,295 | +689 | Never stop coding. The free AI gateway — one endpoint, 160+  |
| 4 | [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 73,702 | +456 | Give your AI agent eyes to see the entire internet. Read & s |
| 5 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 108,938 | +396 | Turn any codebase, with its docs, SQL schemas, configs, and  |
| 6 | [rocketride-org/rocketride-server](https://github.com/rocketride-org/rocketride-server) | 6,938 | +345 | High-performance AI pipeline engine with a C++ core and 50+  |
| 7 | [PostHog/posthog](https://github.com/PostHog/posthog) | 38,148 | +327 | :hedgehog: PostHog is the leading platform for building self |
| 8 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 241,601 | +314 | The agent harness performance optimization system. Skills, i |
| 9 | [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 30,468 | +263 | 734+ structured cybersecurity skills for AI agents · MITRE A |
| 10 | [koala73/worldmonitor](https://github.com/koala73/worldmonitor) | 83,607 | +234 | Real-time global intelligence dashboard. AI-powered news agg |
...
| 12 | [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | 26,206 | +196 | ⌥  AI Coding agent for the terminal — hash-anchored edits, o |
| 13 | [Deuz-AI/Deuz-SDK](https://github.com/Deuz-AI/Deuz-SDK) | 304 | +194 | Zero-dependency TypeScript framework for production AI agent |
| 14 | [holaboss-ai/holaOS](https://github.com/holaboss-ai/holaOS) | 10,528 | +188 | Open-source AI agent workspace. Run any agent — Claude Code, |
| 15 | [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 75,634 | +187 | 🕷️ An adaptive Web Scraping framework that handles everythin |
| 16 | [fuxicodex/Fuxi](https://github.com/fuxicodex/Fuxi) | 1,488 | +184 | FuXi is a fast, self-contained AI coding agent that lives in |
| 17 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 128,640 | +177 | A cross-platform desktop All-in-One assistant tool for Claud |
| 18 | [n8n-io/n8n](https://github.com/n8n-io/n8n) | 201,462 | +161 | Fair-code workflow automation platform with native AI capabi |
...
| 20 | [t8y2/dbx](https://github.com/t8y2/dbx) | 16,168 | +153 | 20 MB lightweight cross-platform database client for 70+ dat |
...
|---------|---:|:--------:|-------------|
| [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) | 89,731 | TypeScript | Model Context Protocol Servers |
...
| [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) | 33,769 | Python | Official, Anthropic-managed directory of high quality Claude Code Plug |
| [modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk) | 24,075 | Python | The official Python SDK for Model Context Protocol servers and clients |
| [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) | 17,028 | Jupyter Notebook | This open-source curriculum introduces the fundamentals of Model Conte |
| [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector) | 14,841 | Python | Security scanner for AI agent skills. Detect vulnerabilities, maliciou |
| [modelcontextprotocol/typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | 13,219 | TypeScript | The official TypeScript SDK for Model Context Protocol servers and cli |
...
| [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | 11,474 | Python | AI-powered reverse engineering assistant that bridges IDA Pro with lan |
| [modelcontextprotocol/inspector](https://github.com/modelcontextprotocol/inspector) | 10,719 | TypeScript | Visual testing tool for MCP servers |
| [mcp-use/mcp-use](https://github.com/mcp-use/mcp-use) | 10,512 | TypeScript | The fullstack MCP framework to develop MCP Apps for ChatGPT / Claude & |
...
| [modelcontextprotocol/modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol) | 9,015 | TypeScript | Specification and documentation for the Model Context Protocol |
| [modelcontextprotocol/registry](https://github.com/modelcontextprotocol/registry) | 7,181 | Go | A community driven registry service for Model Context Protocol (MCP) s |
| [modelcontextprotocol/go-sdk](https://github.com/modelcontextprotocol/go-sdk) | 5,003 | Go | The official Go SDK for Model Context Protocol servers and clients. Ma |
| [makenotion/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | 4,596 | TypeScript | Official Notion MCP Server |
| [modelcontextprotocol/csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk) | 4,487 | C# | The official C# SDK for Model Context Protocol servers and clients. Ma |
| [homeassistant-ai/ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | 4,456 | Python | The Unofficial and Awesome Home Assistant MCP Server |
...
| [modelcontextprotocol/rust-sdk](https://github.com/modelcontextprotocol/rust-sdk) | 3,827 | Rust | The official Rust SDK for the Model Context Protocol |
...
| [microsoft/mcp](https://github.com/microsoft/mcp) | 3,592 | C# | Catalog of official Microsoft MCP (Model Context Protocol) server impl |
...
| [snyk/agent-scan](https://github.com/snyk/agent-scan) | 2,934 | Python | Security scanner for AI agents, MCP servers and agent skills. |
| [modelcontextprotocol/ext-apps](https://github.com/modelcontextprotocol/ext-apps) | 2,745 | TypeScript | Official repo for spec & SDK of MCP Apps protocol - standard for UIs e |
| [perplexityai/modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol) | 2,471 | TypeScript | The official MCP server implementation for the Perplexity API Platform |
| [aws/agent-toolkit-for-aws](https://github.com/aws/agent-toolkit-for-aws) | 2,398 | Python | Official, AWS-supported MCP servers, skills, and plugins to help AI ag |
...
| [containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) | 1,987 | Go | Model Context Protocol (MCP) server for Kubernetes and OpenShift |
...
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 39,763 | Go | MCP server that indexes your codebase into a persistent knowledge grap |
...
| [OtterMind/Chat2DB](https://github.com/OtterMind/Chat2DB) | 28,004 | Java | Chat2DB is a free, cross-platform, local-first database client and SQL |
| [googleapis/mcp-toolbox](https://github.com/googleapis/mcp-toolbox) | 16,228 | Go | MCP Toolbox for Databases is an open source MCP server for databases. |
| [t8y2/dbx](https://github.com/t8y2/dbx) | 16,168 | Rust | 20 MB lightweight cross-platform database client for 70+ databases, in |
...
| [JoeanAmier/XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader) | 12,436 | Python | 小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接； |
| [tobymao/sqlglot](https://github.com/tobymao/sqlglot) | 8,971 | Python | Python SQL Parser and Transpiler |
| [Gentleman-Programming/engram](https://github.com/Gentleman-Programming/engram) | 6,088 | Go | Persistent memory system for AI coding agents. Agent-agnostic Go binar |
| [builderz-labs/mission-control](https://github.com/builderz-labs/mission-control) | 6,045 | TypeScript | Open-source dashboard for AI agent orchestration. Manage agent fleets, |
| [clidey/whodb](https://github.com/clidey/whodb) | 5,010 | Go | Where data access meets operational intelligence |
| [prest/prest](https://github.com/prest/prest) | 4,610 | Go | PostgreSQL ➕ REST, low-code, simplify and accelerate development, ⚡ in |
| [NateBJones-Projects/OB1](https://github.com/NateBJones-Projects/OB1) | 4,483 | TypeScript | Open Brain — The infrastructure layer for your thinking. One database, |
| [panaversity/learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai) | 4,336 | Jupyter Notebook | Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern |
| [TabularisDB/tabularis](https://github.com/TabularisDB/tabularis) | 4,166 | TypeScript | A lightweight, cross-platform database client for developers. Supports |
| [bytebase/dbhub](https://github.com/bytebase/dbhub) | 3,387 | TypeScript | Zero-dependency, token-efficient database MCP server for Postgres, MyS |
| [butterbase-ai/butterbase](https://github.com/butterbase-ai/butterbase) | 3,191 | TypeScript | Open-source backend-as-a-service. Postgres, auth, storage, functions,  |
...
| [crbnos/carbon](https://github.com/crbnos/carbon) | 2,376 | TypeScript | Carbon is an open source ERP, MES and QMS for manufacturing. Perfect f |
...
| [benborla/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | 2,063 | JavaScript | A Model Context Protocol server that provides read-only access to MySQ |
...
| [Syngnat/GoNavi](https://github.com/Syngnat/GoNavi) | 1,869 | TypeScript | 原生轻量数据库客户端（Go + Wails + React，~30MB）：SQL/缓存/向量/消息/国产库，内置 AI 与 MCP，告别 E |
| [timescale/pg-aiguide](https://github.com/timescale/pg-aiguide) | 1,817 | Python | MCP server and Claude plugin for Postgres skills and documentation. He |
...
| [Dataojitori/nocturne_memory](https://github.com/Dataojitori/nocturne_memory) | 1,324 | Python | 一个基于uri而不是RAG的轻量级、可回滚、可视化的 **AI 外挂MCP记忆库**。让你的 AI 拥有跨模型，跨会话，跨工具的持久的结构化 |
...
| [mongodb-js/mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) | 1,103 | TypeScript | A Model Context Protocol server to connect to MongoDB databases and Mo |
...
| [Anarkh-Lee/universal-db-mcp](https://github.com/Anarkh-Lee/universal-db-mcp) | 916 | TypeScript | 通用数据库 MCP 连接器：支持 MySQL、PostgreSQL、Oracle、MongoDB 等 17 种数据库，支持 Claude D |
| [statespace-tech/statespace](https://github.com/statespace-tech/statespace) | 873 | Rust | curl your filesystem and CLI tools |
| [agentic-community/mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | 869 | Python | Enterprise-ready MCP Gateway & Registry that centralizes AI developmen |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | 201,462 | TypeScript | Fair-code workflow automation platform with native AI capabilities. Co |
| [Kong/kong](https://github.com/Kong/kong) | 44,016 | Lua | 🦍 The API and AI Gateway |
| [SigNoz/signoz](https://github.com/SigNoz/signoz) | 31,906 | TypeScript | SigNoz is an open-source, OpenTelemetry-native observability platform  |
| [apache/apisix](https://github.com/apache/apisix) | 16,257 | Lua | The Cloud-Native API Gateway and AI Gateway |
| [triggerdotdev/trigger.dev](https://github.com/triggerdotdev/trigger.dev) | 16,083 | TypeScript | Trigger.dev – build and deploy fully‑managed AI agents and workflows |
...
| [openstatusHQ/openstatus](https://github.com/openstatusHQ/openstatus) | 8,997 | TypeScript | 🫖 Status page with uptime monitoring & API monitoring as code   🫖 |
...
| [oomol-lab/open-connector](https://github.com/oomol-lab/open-connector) | 4,835 | TypeScript | Open-source auth gateway connecting 1000+ SaaS providers to AI agents  |
| [agentgateway/agentgateway](https://github.com/agentgateway/agentgateway) | 4,462 | Rust | Next Generation Agentic Proxy for AI Agents and MCP servers |
| [IBM/mcp-context-forge](https://github.com/IBM/mcp-context-forge) | 4,345 | Python | An AI Gateway, registry, and proxy that sits in front of any MCP, A2A, |
| [txn2/kubefwd](https://github.com/txn2/kubefwd) | 4,161 | Go | Bulk port forwarding Kubernetes services for local development. |
| [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | 4,098 | TypeScript |  |
| [octelium/octelium](https://github.com/octelium/octelium) | 4,015 | Go | A next-gen FOSS self-hosted unified zero trust secure access platform  |
| [bethington/ghidra-mcp](https://github.com/bethington/ghidra-mcp) | 3,397 | Java | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. |
| [skyhook-io/radar](https://github.com/skyhook-io/radar) | 3,034 | TypeScript | Modern Kubernetes visibility. Topology, event timeline, and service tr |
| [microsoft/skills](https://github.com/microsoft/skills) | 2,928 | TypeScript | Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Codin |
| [metatool-ai/metamcp](https://github.com/metatool-ai/metamcp) | 2,615 | TypeScript | MCP Aggregator, Orchestrator, Middleware, Gateway in one docker |
| [AmoyLab/Unla](https://github.com/AmoyLab/Unla) | 2,211 | TypeScript | 🧩 MCP Gateway - A lightweight gateway service that instantly transform |
...
| [stacklok/toolhive](https://github.com/stacklok/toolhive) | 2,030 | Go | ToolHive makes deploying MCP servers easy, secure and fun |
...
| [awslabs/cli-agent-orchestrator](https://github.com/awslabs/cli-agent-orchestrator) | 1,091 | Python | Multi-agent orchestration for AI coding CLIs — Claude Code, Kiro, Code |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 128,640 | TypeScript | A cross-platform desktop All-in-One assistant tool for Claude Code, Co |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | 106,594 | TypeScript | An open-source AI agent that brings the power of Gemini directly into  |
| [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 73,702 | Python | Give your AI agent eyes to see the entire internet. Read & search Twit |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 72,943 | Python | A curated list of awesome Claude Skills, resources, and tools for cust |
| [sickn33/agentic-awesome-skills](https://github.com/sickn33/agentic-awesome-skills) | 45,219 | Python | Installable GitHub library of 1,935+ agentic skills for Claude Code, C |
...
| [mindsdb/mindshub](https://github.com/mindsdb/mindshub) | 39,619 | Makefile | Make AI do actual work. Swap the model anytime — keep everything you'v |
| [PostHog/posthog](https://github.com/PostHog/posthog) | 38,148 | Python | :hedgehog: PostHog is the leading platform for building self-driving p |
| [github/github-mcp-server](https://github.com/github/github-mcp-server) | 32,402 | Go | GitHub's official MCP Server |
| [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 30,468 | Python | 734+ structured cybersecurity skills for AI agents · MITRE ATT&CK mapp |
| [PrefectHQ/fastmcp](https://github.com/PrefectHQ/fastmcp) | 27,320 | Python | 🚀 The fast, Pythonic way to build MCP servers and clients. |
| [jlowin/fastmcp](https://github.com/PrefectHQ/fastmcp) | 23,286 | Python | 🚀 The fast, Pythonic way to build MCP servers and clients. |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | 20,038 | TypeScript | MCP is the protocol for tool access. We're the virtualization layer fo |
| [electerm/electerm](https://github.com/electerm/electerm) | 14,899 | JavaScript | 📻Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client(linux, m |
| [yusufkaraaslan/Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | 14,790 | Python | Convert documentation websites, GitHub repositories, and PDFs into Cla |
...
| [0x4m4/hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | 11,252 | Python | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents  |
| [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | 10,904 | Python | AI quantitative trading platform for crypto, stocks, and forex with ba |
| [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) | 10,524 | JavaScript | Practical patterns, starters & CLI tools for loop engineering with AI  |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | 9,366 | TypeScript | This is MCP server for Claude that gives it terminal control, file sys |
| [idosal/git-mcp](https://github.com/idosal/git-mcp) | 8,339 | TypeScript | Put an end to code hallucinations! GitMCP is a free, open-source, remo |
| [firerpa/lamda](https://github.com/firerpa/lamda) | 8,214 | Python | The most powerful Android RPA agent framework, next generation of mobi |
| [google-labs-code/stitch-skills](https://github.com/google-labs-code/stitch-skills) | 8,135 | TypeScript | A library of Agent Skills designed to work with the Stitch MCP server. |
| [jnMetaCode/superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | 7,767 | Shell | AI 编程超能力中文版 — superpowers 完整汉化 + 中国特色 skills（Gitee/Coding 工作流、中文排版、MCP |
| [yzfly/Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH) | 7,587 | - | MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients |
| [maximhq/bifrost](https://github.com/maximhq/bifrost) | 7,475 | Go | Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive  |
| [rocketride-org/rocketride-server](https://github.com/rocketride-org/rocketride-server) | 6,938 | C++ | High-performance AI pipeline engine with a C++ core and 50+ Python-ext |
| [punkpeye/awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients) | 6,550 | - | A collection of MCP clients. |
| [getsentry/XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP) | 6,266 | TypeScript | A Model Context Protocol (MCP) server and CLI that provides tools for  |
| [epiral/bb-browser](https://github.com/epiral/bb-browser) | 6,063 | TypeScript | Your browser is the API. CLI + MCP server for AI agents to control Chr |
| [kucherenko/jscpd](https://github.com/kucherenko/jscpd) | 6,036 | TypeScript | Copy/paste detector for programming source code, supports 223 formats. |
| [jacob-bd/gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | 5,903 | Python | Programmatic access to Gemini Notebook - via command-line interface (C |
| [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | 5,779 | Python | MCP server for Atlassian tools (Confluence, Jira) |
| [agent-infra/sandbox](https://github.com/agent-infra/sandbox) | 5,762 | Python | All-in-One Sandbox for AI Agents that combines Browser, Shell, File, M |
| [21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp) | 5,701 | TypeScript | It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP ser |
...
| [Q00/ouroboros](https://github.com/Q00/ouroboros) | 5,602 | Python | Agent OS: Stop prompting. Start specifying. A Socratic interview gates |
| [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) | 5,514 | TypeScript | AI-native open-source design tool. Design-as-Code.Prompt to UI on canv |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 75,634 | Python | 🕷️ An adaptive Web Scraping framework that handles everything from a s |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 49,526 | TypeScript | Chrome DevTools for coding agents |
| [bytedance/UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop) | 38,669 | TypeScript | The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI  |
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 36,329 | TypeScript | Playwright MCP server |
| [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | 29,064 | Python | An autonomous agent that conducts deep research on any data using any  |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | 14,239 | Go | An open-source AI-first Identity and Access Management (IAM) /AI MCP g |
| [hangwin/mcp-chrome](https://github.com/hangwin/mcp-chrome) | 12,326 | TypeScript | Chrome MCP Server is a Chrome extension-based Model Context Protocol ( |
| [firecrawl/firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | 7,283 | JavaScript | 🔥 Official Firecrawl MCP Server - Adds powerful web scraping and searc |
| [BrowserMCP/mcp](https://github.com/BrowserMCP/mcp) | 7,000 | TypeScript | Browser MCP is a Model Context Provider (MCP) server that allows AI ap |
| [netease-youdao/LobsterAI](https://github.com/netease-youdao/LobsterAI) | 5,936 | TypeScript | Open-source, desktop-grade AI agent that gets real work done — data an |
| [MinishLab/semble](https://github.com/MinishLab/semble) | 5,922 | Python | Fast and Accurate Code Search for Agents. Uses ~98% fewer tokens than  |
...
| [joeseesun/qiaomu-anything-to-notebooklm](https://github.com/joeseesun/qiaomu-anything-to-notebooklm) | 5,773 | Python | Claude Skill: Multi-source content processor for NotebookLM. Supports  |
...
| [0xNyk/awesome-hermes-agent](https://github.com/0xNyk/awesome-hermes-agent) | 5,400 | - | Independent directory of useful skills, plugins, memory providers, too |
| [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | 4,895 | TypeScript | Exa MCP for web search and web crawling! |
| [KnockOutEZ/wigolo](https://github.com/KnockOutEZ/wigolo) | 4,612 | TypeScript | The go-to web for your AI coding agent — local-first search, fetch, cr |
| [apify/apify-mcp-server](https://github.com/apify/apify-mcp-server) | 4,447 | TypeScript | The Apify MCP server enables your AI agents to extract data from socia |
...
| [nowork-studio/notfair-plugin](https://github.com/nowork-studio/notfair-plugin) | 3,388 | TypeScript | Open-source SEO, GEO, and marketing skills for AI agents. |
...
| [stickerdaniel/linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | 3,186 | Python | This MCP server allows Claude and other AI assistants to access your L |
...
| [punitarani/fli](https://github.com/punitarani/fli) | 3,115 | Python | Google Flights MCP and Python Library |
...
| [taylorwilsdon/google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | 3,049 | Python | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas |
| [deedy5/ddgs](https://github.com/deedy5/ddgs) | 2,907 | Python | A metasearch library that aggregates results from diverse web search s |
| [Vexa-ai/vexa](https://github.com/Vexa-ai/vexa) | 2,703 | Python | Open-source meeting transcription API for Google Meet, Microsoft Teams |
...
| [brightdata/brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | 2,605 | JavaScript | A powerful Model Context Protocol (MCP) server that provides an all-in |
...
| [tavily-ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | 2,343 | JavaScript | Production ready MCP server with real-time search, extract, map & craw |
...
| [0xMassi/webclaw](https://github.com/0xMassi/webclaw) | 2,292 | Rust | Fast, local-first web content extraction for LLMs. Scrape, crawl, extr |
| [llmsresearch/paperbanana](https://github.com/llmsresearch/paperbanana) | 2,256 | Python | Open source implementation and extension of Google Research’s PaperBan |
...
| [aklivity/zilla](https://github.com/aklivity/zilla) | 1,699 | Java | 🦎 A high-performance, multi-protocol gateway for Apache Kafka and AI.  |
...
| [ZeroPointRepo/awesome-hermes-skills](https://github.com/ZeroPointRepo/awesome-hermes-skills) | 439 | - | Curated, install-ready directory for the Hermes Agent ecosystem (v0.20 |
| [tugcantopaloglu/godot-mcp](https://github.com/tugcantopaloglu/godot-mcp) | 423 | JavaScript | MCP server for full Godot 4.x engine control — 149 tools for AI-driven |
...
| [w0h1v/mcp-virustotal](https://github.com/w0h1v/mcp-virustotal) | 147 | TypeScript | MCP server for VirusTotal API — analyze URLs, files, IPs, and domains  |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | 241,601 | JavaScript | The agent harness performance optimization system. Skills, instincts,  |
...
| [langgenius/dify](https://github.com/langgenius/dify) | 153,112 | TypeScript | Production-ready platform for agentic workflow development. |
...
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 108,938 | Python | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into |
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | 92,649 | - | A collection of MCP servers. |
| [koala73/worldmonitor](https://github.com/koala73/worldmonitor) | 83,607 | TypeScript | Real-time global intelligence dashboard. AI-powered news aggregation,  |
| [lobehub/lobehub](https://github.com/lobehub/lobehub) | 81,889 | TypeScript | The ultimate space for work and life — to find, build, and collaborate |
...
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 68,552 | TypeScript | 🌊 The leading agent orchestration platform for Claude. Deploy intellig |
| [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) | 67,063 | Python | Compress tool outputs, logs, files, and RAG chunks before they reach t |
| [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) | 61,643 | Python | ⭐AI-driven public opinion & trend monitor with multi-platform aggregat |
| [upstash/context7](https://github.com/upstash/context7) | 61,039 | TypeScript | Context7 MCP Server -- Up-to-date code documentation for LLMs and AI c |
| [zylon-ai/private-gpt](https://github.com/zylon-ai/private-gpt) | 57,450 | Python | Complete API layer for private AI applications on local models: RAG, s |
...
| [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 52,295 | TypeScript | Never stop coding. The free AI gateway — one endpoint, 160+ providers, |
...
| [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | 47,250 | Python | Ultra-lightweight, open-source, self-hosted personal AI agent framewor |
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | 46,616 | Python | CowAgent (chatgpt-on-wechat) 是基于大模型的超级AI助理，能主动思考和任务规划、访问操作系统和外部资源、创造和执 |
...
| [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) | 42,303 | TypeScript | Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS |
| [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 41,412 | TypeScript | A one-of-a-kind resume builder that keeps your privacy in mind. Comple |
| [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | 39,447 | Python | Agentic IM Chatbot infrastructure that integrates lots of IM platforms |
| [wshobson/agents](https://github.com/wshobson/agents) | 38,985 | Python | Multi-harness agentic plugin marketplace for Claude Code, Codex CLI, C |
...
| [tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) | 30,657 | Python | Local knowledge graph for Claude Code. Builds a persistent map of your |
| [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 29,801 | TypeScript | Composio powers 1000+ toolkits, tool search, context management, authe |
| [labring/FastGPT](https://github.com/labring/FastGPT) | 29,415 | TypeScript | FastGPT is a knowledge-based platform built on the LLMs, offers a comp |
| [oraios/serena](https://github.com/oraios/serena) | 28,319 | Python | A powerful coding agent toolkit providing semantic retrieval and editi |
| [yamadashy/repomix](https://github.com/yamadashy/repomix) | 27,988 | TypeScript | 📦 Repomix is a powerful tool that packs your entire repository into a  |
| [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | 26,206 | TypeScript | ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized t |
| [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) | 26,119 | Python |  |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [KroMiose/nekro-agent](https://github.com/KroMiose/nekro-agent) | 1,095 | Python | NekroAgent 是一个面向多人互动场景的跨平台 Agent 框架，集 Claude Code 沙盒执行、工作区编排、长期记忆、结构化  |
| [TryCaspian/caspian-sdk](https://github.com/TryCaspian/caspian-sdk) | 810 | Python | One identity for your AI agent across Slack, Discord, Telegram, WhatsA |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) | 4,320 | Python | MCP server that interacts with Obsidian via the Obsidian rest API comm |
| [coddingtonbear/obsidian-local-rest-api](https://github.com/coddingtonbear/obsidian-local-rest-api) | 2,824 | TypeScript | A secure REST API and Model Context Protocol (MCP) server for your vau |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata) | 14,934 | TypeScript | OpenMetadata is a unified metadata platform for data discovery, data o |
...
| [microsoft/flint-chart](https://github.com/microsoft/flint-chart) | 3,901 | TypeScript | 🪄 Flint is a visualization language that lets AI agents reliably creat |
| [dagucloud/dagu](https://github.com/dagucloud/dagu) | 3,783 | Go | Lightweight, powerful workflow engine built in a single binary with We |
...
| [julien040/anyquery](https://github.com/julien040/anyquery) | 1,762 | Go | Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatG |
| [slothflowlabs/duckle](https://github.com/slothflowlabs/duckle) | 1,186 | Rust | Open-source self-hosted ETL and ELT tool on DuckDB. Low-code visual da |
...
| [artokun/comfyui-mcp](https://github.com/artokun/comfyui-mcp) | 637 | TypeScript | ComfyUI MCP server + Claude Code plugin — workflow execution, visualiz |
...
| [aikts/yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp) | 106 | Python | Yandex Tracker MCP Server with OAuth2 support |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | 22,744 | TypeScript | A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8 |
| [xpzouying/xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | 15,402 | Go | MCP for xiaohongshu.com |
| [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) | 9,840 | Java | MCP Server for Ghidra |
| [golang/tools](https://github.com/golang/tools) | 7,898 | Go | [mirror] Go Tools |
| [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) | 5,965 | TypeScript | Model Context Protocol Server for Mobile Automation and Scraping (iOS, |
| [wong2/awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers) | 4,270 | - | A curated list of Model Context Protocol (MCP) servers |
...
| [sparfenyuk/mcp-proxy](https://github.com/sparfenyuk/mcp-proxy) | 2,719 | Python | A bridge between Streamable HTTP and stdio MCP transports |
...
| [rohitg00/awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit) | 2,535 | JavaScript | The most comprehensive toolkit for Claude Code -- 135 agents, 35 curat |
| [samanhappy/mcphub](https://github.com/samanhappy/mcphub) | 2,311 | TypeScript | A unified hub for centrally managing and dynamically orchestrating mul |
| [louislva/claude-peers-mcp](https://github.com/louislva/claude-peers-mcp) | 2,197 | TypeScript | Allow all your Claude Codes to message each other ad-hoc! |
| [joshuayoes/ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) | 2,140 | JavaScript | MCP server for interacting with the iOS simulator |
| [figma/mcp-server-guide](https://github.com/figma/mcp-server-guide) | 1,911 | JavaScript | A guide on how to use the Figma MCP server |
| [neka-nat/freecad-mcp](https://github.com/neka-nat/freecad-mcp) | 1,869 | Python | FreeCAD MCP(Model Context Protocol) server |
...
| [svnscha/mcp-windbg](https://github.com/svnscha/mcp-windbg) | 1,528 | Python | Model Context Protocol for WinDBG |
...
| [WenXiaoWendy/cyberboss](https://github.com/WenXiaoWendy/cyberboss) | 1,320 | JavaScript | 一个接入微信的本地生活 Agent Bridge，让 Codex / Claude Code 拥有时间感、行踪感、随机唤醒和自主唤醒能力，用 |
...
| [jordanrendric/claude-video-vision](https://github.com/jordanrendric/claude-video-vision) | 1,251 | TypeScript | Give Claude the ability to watch and understand videos — Claude Code p |
...
<p align="center"><sub>✨ Auto-curated · 2026-08-21 20:10:46</sub></p>
