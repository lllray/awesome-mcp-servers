...
![Total](https://img.shields.io/badge/Total-5183-blue?style=flat-square) ![Stars](https://img.shields.io/badge/Stars-7197k%2B-yellow?style=flat-square) ![Today](https://img.shields.io/badge/Today-8-green?style=flat-square) ![Updated](https://img.shields.io/badge/Updated-2026-08-30-orange?style=flat-square)
...
| 3 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 58,355 | +552 | Never stop coding. The free AI gateway — one endpoint, 160+  |
| 4 | [miuuyy/codex-chatgpt-web](https://github.com/miuuyy/codex-chatgpt-web) | 2,539 | +541 | Use ChatGPT Web (including Pro) as a native model in the Cod |
| 5 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 244,478 | +412 | The agent harness performance optimization system. Skills, i |
| 6 | [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) | 35,563 | +365 | Official, Anthropic-managed directory of high quality Claude |
| 7 | [NanoNets/Graft](https://github.com/NanoNets/Graft) | 4,665 | +355 | Turbocharge Claude Code, Cursor, Codex, Gemini & every codin |
| 8 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 112,464 | +311 | Turn any codebase, with its docs, SQL schemas, configs, and  |
| 9 | [fuxicodex/Fuxi](https://github.com/fuxicodex/Fuxi) | 2,926 | +253 | FuXi is a fast, self-contained AI coding agent that lives in |
| 10 | [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 77,283 | +235 | 🕷️ An adaptive Web Scraping framework that handles everythin |
| 11 | [koala73/worldmonitor](https://github.com/koala73/worldmonitor) | 84,987 | +234 | Real-time global intelligence dashboard. AI-powered news agg |
| 12 | [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 76,663 | +204 | Give your AI agent eyes to see the entire internet. Read & s |
...
| 14 | [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 74,038 | +190 | A curated list of awesome Claude Skills, resources, and tool |
| 15 | [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | 28,397 | +179 | ⌥  AI Coding agent for the terminal — hash-anchored edits, o |
...
| 17 | [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 41,216 | +158 | MCP server that indexes your codebase into a persistent know |
| 18 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 130,158 | +128 | A cross-platform desktop All-in-One assistant tool for Claud |
| 19 | [CopilotKit/OpenBot](https://github.com/CopilotKit/OpenBot) | 3,491 | +127 | Open-source AI coworkers that each get a computer of their o |
| 20 | [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 50,189 | +121 | Chrome DevTools for coding agents |
...
|---------|---:|:--------:|-------------|
| [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) | 89,965 | TypeScript | Model Context Protocol Servers |
...
| [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) | 35,563 | Python | Official, Anthropic-managed directory of high quality Claude Code Plug |
| [modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk) | 24,158 | Python | The official Python SDK for Model Context Protocol servers and clients |
| [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) | 17,113 | Jupyter Notebook | This open-source curriculum introduces the fundamentals of Model Conte |
| [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector) | 15,239 | Python | Security scanner for AI agent skills. Detect vulnerabilities, maliciou |
| [modelcontextprotocol/typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | 13,281 | TypeScript | The official TypeScript SDK for Model Context Protocol servers and cli |
| [creativetimofficial/ui](https://github.com/creativetimofficial/ui) | 12,019 | TypeScript | Open-source components, blocks, and AI agents designed to speed up you |
| [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | 11,695 | Python | AI-powered reverse engineering assistant that bridges IDA Pro with lan |
| [modelcontextprotocol/inspector](https://github.com/modelcontextprotocol/inspector) | 10,787 | TypeScript | Visual testing tool for MCP servers |
...
| [awslabs/mcp](https://github.com/awslabs/mcp) | 9,644 | Python | Official MCP Servers for AWS |
...
| [modelcontextprotocol/modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol) | 9,083 | TypeScript | Specification and documentation for the Model Context Protocol |
| [modelcontextprotocol/registry](https://github.com/modelcontextprotocol/registry) | 7,202 | Go | A community driven registry service for Model Context Protocol (MCP) s |
| [modelcontextprotocol/go-sdk](https://github.com/modelcontextprotocol/go-sdk) | 5,038 | Go | The official Go SDK for Model Context Protocol servers and clients. Ma |
| [makenotion/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | 4,613 | TypeScript | Official Notion MCP Server |
| [homeassistant-ai/ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | 4,562 | Python | The Unofficial and Awesome Home Assistant MCP Server |
...
| [modelcontextprotocol/rust-sdk](https://github.com/modelcontextprotocol/rust-sdk) | 3,855 | Rust | The official Rust SDK for the Model Context Protocol |
| [modelcontextprotocol/java-sdk](https://github.com/modelcontextprotocol/java-sdk) | 3,674 | Java | The official Java SDK for Model Context Protocol servers and clients.  |
| [microsoft/mcp](https://github.com/microsoft/mcp) | 3,625 | C# | Catalog of official Microsoft MCP (Model Context Protocol) server impl |
...
| [huangjunsen0406/py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi) | 3,455 | Python | A Python-based Xiaozhi AI for users who want the full Xiaozhi experien |
...
| [snyk/agent-scan](https://github.com/snyk/agent-scan) | 2,978 | Python | Security scanner for AI agents, MCP servers and agent skills. |
| [modelcontextprotocol/ext-apps](https://github.com/modelcontextprotocol/ext-apps) | 2,773 | TypeScript | Official repo for spec & SDK of MCP Apps protocol - standard for UIs e |
| [perplexityai/modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol) | 2,492 | TypeScript | The official MCP server implementation for the Perplexity API Platform |
| [aws/agent-toolkit-for-aws](https://github.com/aws/agent-toolkit-for-aws) | 2,476 | Python | Official, AWS-supported MCP servers, skills, and plugins to help AI ag |
...
| [modelcontextprotocol/mcpb](https://github.com/modelcontextprotocol/mcpb) | 2,091 | TypeScript | Desktop Extensions: One-click local MCP server installation in desktop |
...
| [containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) | 2,038 | Go | Model Context Protocol (MCP) server for Kubernetes and OpenShift |
...
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 41,216 | Go | MCP server that indexes your codebase into a persistent knowledge grap |
...
| [OtterMind/Chat2DB](https://github.com/OtterMind/Chat2DB) | 28,052 | Java | Chat2DB is a free, cross-platform, local-first database client and SQL |
| [t8y2/dbx](https://github.com/t8y2/dbx) | 17,450 | Rust | 20 MB lightweight cross-platform database client for 70+ databases, in |
| [googleapis/mcp-toolbox](https://github.com/googleapis/mcp-toolbox) | 16,278 | Go | MCP Toolbox for Databases is an open source MCP server for databases. |
...
| [JoeanAmier/XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader) | 12,535 | Python | 小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接； |
| [tobymao/sqlglot](https://github.com/tobymao/sqlglot) | 8,971 | Python | Python SQL Parser and Transpiler |
| [Gentleman-Programming/engram](https://github.com/Gentleman-Programming/engram) | 6,232 | Go | Persistent memory system for AI coding agents. Agent-agnostic Go binar |
| [builderz-labs/mission-control](https://github.com/builderz-labs/mission-control) | 6,138 | TypeScript | Open-source dashboard for AI agent orchestration. Manage agent fleets, |
...
| [NateBJones-Projects/OB1](https://github.com/NateBJones-Projects/OB1) | 4,523 | TypeScript | Open Brain — The infrastructure layer for your thinking. One database, |
| [TabularisDB/tabularis](https://github.com/TabularisDB/tabularis) | 4,484 | TypeScript | A lightweight, cross-platform database client for developers. Supports |
...
| [bytebase/dbhub](https://github.com/bytebase/dbhub) | 3,429 | TypeScript | Zero-dependency, token-efficient database MCP server for Postgres, MyS |
| [butterbase-ai/butterbase](https://github.com/butterbase-ai/butterbase) | 3,332 | TypeScript | Open-source backend-as-a-service. Postgres, auth, storage, functions,  |
| [xpf0000/FlyEnv](https://github.com/xpf0000/FlyEnv) | 3,184 | TypeScript | Native local development environment for Windows, macOS & Linux. Run P |
...
| [benborla/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | 2,089 | JavaScript | A Model Context Protocol server that provides read-only access to MySQ |
...
| [Syngnat/GoNavi](https://github.com/Syngnat/GoNavi) | 1,884 | TypeScript | 原生轻量数据库客户端（Go + Wails + React，~30MB）：SQL/缓存/向量/消息/国产库，内置 AI 与 MCP，告别 E |
...
| [designcomputer/mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server) | 1,373 | Python | A Model Context Protocol (MCP) server that enables secure interaction  |
| [Dataojitori/nocturne_memory](https://github.com/Dataojitori/nocturne_memory) | 1,337 | Python | 一个基于uri而不是RAG的轻量级、可回滚、可视化的 **AI 外挂MCP记忆库**。让你的 AI 拥有跨模型，跨会话，跨工具的持久的结构化 |
...
| [mongodb-js/mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) | 1,114 | TypeScript | A Model Context Protocol server to connect to MongoDB databases and Mo |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | 202,835 | TypeScript | Fair-code workflow automation platform with native AI capabilities. Co |
| [Kong/kong](https://github.com/Kong/kong) | 44,059 | Lua | 🦍 The API and AI Gateway |
| [SigNoz/signoz](https://github.com/SigNoz/signoz) | 31,972 | TypeScript | SigNoz is an open-source, OpenTelemetry-native observability platform  |
| [apache/apisix](https://github.com/apache/apisix) | 16,257 | Lua | The Cloud-Native API Gateway and AI Gateway |
| [triggerdotdev/trigger.dev](https://github.com/triggerdotdev/trigger.dev) | 16,164 | TypeScript | Trigger.dev – build and deploy fully‑managed AI agents and workflows |
...
| [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) | 11,465 | Go | Yet another WebUI for Nginx |
| [openstatusHQ/openstatus](https://github.com/openstatusHQ/openstatus) | 9,031 | TypeScript | 🫖 Status page with uptime monitoring & API monitoring as code   🫖 |
...
| [oomol-lab/open-connector](https://github.com/oomol-lab/open-connector) | 5,419 | TypeScript | Open-source auth gateway connecting 1000+ SaaS providers to AI agents  |
...
| [agentgateway/agentgateway](https://github.com/agentgateway/agentgateway) | 4,641 | Rust | Next Generation Agentic Proxy for AI Agents and MCP servers |
...
| [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | 4,127 | TypeScript |  |
...
| [bethington/ghidra-mcp](https://github.com/bethington/ghidra-mcp) | 3,607 | Java | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. |
| [skyhook-io/radar](https://github.com/skyhook-io/radar) | 3,165 | TypeScript | Modern Kubernetes visibility. Topology, event timeline, and service tr |
| [microsoft/skills](https://github.com/microsoft/skills) | 2,972 | TypeScript | Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Codin |
...
| [stacklok/toolhive](https://github.com/stacklok/toolhive) | 2,055 | Go | ToolHive makes deploying MCP servers easy, secure and fun |
...
| [theNetworkChuck/docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial) | 1,613 | - | Complete tutorial materials for building MCP servers with Docker - fro |
...
| [ridafkih/keeper.sh](https://github.com/ridafkih/keeper.sh) | 1,264 | TypeScript | Open-source calendar sync tool. Aggregate events from Google, Outlook, |
| [Azure/azure-mcp](https://github.com/Azure/azure-mcp) | 1,223 | C# | The Azure MCP Server, bringing the power of Azure to your agents. |
| [awslabs/cli-agent-orchestrator](https://github.com/awslabs/cli-agent-orchestrator) | 1,151 | Python | Multi-agent orchestration for AI coding CLIs — Claude Code, Kiro, Code |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 130,158 | TypeScript | A cross-platform desktop All-in-One assistant tool for Claude Code, Co |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | 106,749 | TypeScript | An open-source AI agent that brings the power of Gemini directly into  |
| [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 76,663 | Python | Give your AI agent eyes to see the entire internet. Read & search Twit |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 74,038 | Python | A curated list of awesome Claude Skills, resources, and tools for cust |
| [sickn33/agentic-awesome-skills](https://github.com/sickn33/agentic-awesome-skills) | 45,686 | Python | Installable GitHub library of 1,935+ agentic skills for Claude Code, C |
...
| [PostHog/posthog](https://github.com/PostHog/posthog) | 39,480 | Python | :hedgehog: PostHog is the leading platform for building self-driving p |
| [github/github-mcp-server](https://github.com/github/github-mcp-server) | 32,605 | Go | GitHub's official MCP Server |
| [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 31,668 | Python | 734+ structured cybersecurity skills for AI agents · MITRE ATT&CK mapp |
| [PrefectHQ/fastmcp](https://github.com/PrefectHQ/fastmcp) | 27,438 | Python | 🚀 The fast, Pythonic way to build MCP servers and clients. |
| [jlowin/fastmcp](https://github.com/PrefectHQ/fastmcp) | 23,286 | Python | 🚀 The fast, Pythonic way to build MCP servers and clients. |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | 20,252 | TypeScript | MCP is the protocol for tool access. We're the virtualization layer fo |
| [electerm/electerm](https://github.com/electerm/electerm) | 14,957 | JavaScript | 📻Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client(linux, m |
| [yusufkaraaslan/Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | 14,860 | Python | Convert documentation websites, GitHub repositories, and PDFs into Cla |
...
| [0x4m4/hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | 11,447 | Python | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents  |
| [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | 11,230 | Python | AI quantitative trading platform for crypto, stocks, and forex with ba |
| [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) | 10,736 | JavaScript | Practical patterns, starters & CLI tools for loop engineering with AI  |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | 9,439 | TypeScript | This is MCP server for Claude that gives it terminal control, file sys |
| [idosal/git-mcp](https://github.com/idosal/git-mcp) | 8,360 | TypeScript | Put an end to code hallucinations! GitMCP is a free, open-source, remo |
| [firerpa/lamda](https://github.com/firerpa/lamda) | 8,258 | Python | The most powerful Android RPA agent framework, next generation of mobi |
| [google-labs-code/stitch-skills](https://github.com/google-labs-code/stitch-skills) | 8,220 | TypeScript | A library of Agent Skills designed to work with the Stitch MCP server. |
| [jnMetaCode/superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | 7,893 | Shell | AI 编程超能力中文版 — superpowers 完整汉化 + 中国特色 skills（Gitee/Coding 工作流、中文排版、MCP |
| [maximhq/bifrost](https://github.com/maximhq/bifrost) | 7,655 | Go | Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive  |
| [yzfly/Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH) | 7,615 | - | MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients |
| [rocketride-org/rocketride-server](https://github.com/rocketride-org/rocketride-server) | 7,453 | C++ | High-performance AI pipeline engine with a C++ core and 50+ Python-ext |
| [punkpeye/awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients) | 6,562 | - | A collection of MCP clients. |
...
| [epiral/bb-browser](https://github.com/epiral/bb-browser) | 6,153 | TypeScript | Your browser is the API. CLI + MCP server for AI agents to control Chr |
| [kucherenko/jscpd](https://github.com/kucherenko/jscpd) | 6,072 | TypeScript | Copy/paste detector for programming source code, supports 223 formats. |
| [jacob-bd/gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | 5,973 | Python | Programmatic access to Gemini Notebook - via command-line interface (C |
| [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | 5,813 | Python | MCP server for Atlassian tools (Confluence, Jira) |
| [agent-infra/sandbox](https://github.com/agent-infra/sandbox) | 5,808 | Python | All-in-One Sandbox for AI Agents that combines Browser, Shell, File, M |
| [21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp) | 5,756 | TypeScript | It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP ser |
| [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) | 5,731 | TypeScript | AI-native open-source design tool. Design-as-Code.Prompt to UI on canv |
| [Q00/ouroboros](https://github.com/Q00/ouroboros) | 5,730 | Python | Agent OS: Stop prompting. Start specifying. A Socratic interview gates |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 77,283 | Python | 🕷️ An adaptive Web Scraping framework that handles everything from a s |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 50,189 | TypeScript | Chrome DevTools for coding agents |
| [bytedance/UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop) | 38,749 | TypeScript | The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI  |
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 36,619 | TypeScript | Playwright MCP server |
| [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | 29,205 | Python | An autonomous agent that conducts deep research on any data using any  |
| [casdoor/casdoor](https://github.com/casdoor/casdoor) | 14,294 | Go | An open-source AI-first Identity and Access Management (IAM) /AI MCP g |
...
| [firecrawl/firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | 7,352 | JavaScript | 🔥 Official Firecrawl MCP Server - Adds powerful web scraping and searc |
| [BrowserMCP/mcp](https://github.com/BrowserMCP/mcp) | 7,031 | TypeScript | Browser MCP is a Model Context Provider (MCP) server that allows AI ap |
| [MinishLab/semble](https://github.com/MinishLab/semble) | 5,968 | Python | Fast and Accurate Code Search for Agents. Uses ~98% fewer tokens than  |
...
| [joeseesun/qiaomu-anything-to-notebooklm](https://github.com/joeseesun/qiaomu-anything-to-notebooklm) | 5,892 | Python | Claude Skill: Multi-source content processor for NotebookLM. Supports  |
...
| [0xNyk/awesome-hermes-agent](https://github.com/0xNyk/awesome-hermes-agent) | 5,503 | - | Independent directory of useful skills, plugins, memory providers, too |
| [apify/apify-mcp-server](https://github.com/apify/apify-mcp-server) | 5,395 | TypeScript | The Apify MCP server enables your AI agents to extract data from socia |
| [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | 4,946 | TypeScript | Exa MCP for web search and web crawling! |
| [KnockOutEZ/wigolo](https://github.com/KnockOutEZ/wigolo) | 4,765 | TypeScript | The go-to web for your AI coding agent — local-first search, fetch, cr |
...
| [Manavarya09/design-extract](https://github.com/Manavarya09/design-extract) | 3,978 | JavaScript | Extract any website's complete design system with one command. DTCG to |
...
| [nowork-studio/notfair-plugin](https://github.com/nowork-studio/notfair-plugin) | 3,430 | TypeScript | Open-source SEO, GEO, and marketing skills for AI agents. |
...
| [asciimoo/hister](https://github.com/asciimoo/hister) | 3,310 | Go | Your own search engine |
| [stickerdaniel/linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | 3,268 | Python | This MCP server allows Claude and other AI assistants to access your L |
...
| [punitarani/fli](https://github.com/punitarani/fli) | 3,126 | Python | Google Flights MCP and Python Library |
| [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | 3,095 | Python | A Model Context Protocol server for searching and analyzing arXiv pape |
| [taylorwilsdon/google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | 3,086 | Python | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas |
...
| [Vexa-ai/vexa](https://github.com/Vexa-ai/vexa) | 2,728 | Python | Open-source meeting transcription API for Google Meet, Microsoft Teams |
| [papersgpt/papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero) | 2,619 | JavaScript | A powerful Zotero AI and MCP plugin with ChatGPT, Gemini 3.1, Claude,  |
| [brightdata/brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | 2,616 | JavaScript | A powerful Model Context Protocol (MCP) server that provides an all-in |
...
| [miuuyy/codex-chatgpt-web](https://github.com/miuuyy/codex-chatgpt-web) | 2,539 | TypeScript | Use ChatGPT Web (including Pro) as a native model in the Codex app — w |
| [tavily-ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | 2,362 | JavaScript | Production ready MCP server with real-time search, extract, map & craw |
...
| [ZeroPointRepo/awesome-hermes-skills](https://github.com/ZeroPointRepo/awesome-hermes-skills) | 482 | - | Curated, install-ready directory for the Hermes Agent ecosystem (v0.20 |
| [tugcantopaloglu/godot-mcp](https://github.com/tugcantopaloglu/godot-mcp) | 442 | JavaScript | MCP server for full Godot 4.x engine control — 149 tools for AI-driven |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | 244,478 | JavaScript | The agent harness performance optimization system. Skills, instincts,  |
...
| [langgenius/dify](https://github.com/langgenius/dify) | 153,884 | TypeScript | Production-ready platform for agentic workflow development. |
...
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 112,464 | Python | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into |
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | 93,106 | - | A collection of MCP servers. |
| [koala73/worldmonitor](https://github.com/koala73/worldmonitor) | 84,987 | TypeScript | Real-time global intelligence dashboard. AI-powered news aggregation,  |
| [lobehub/lobehub](https://github.com/lobehub/lobehub) | 82,095 | TypeScript | The ultimate space for work and life — to find, build, and collaborate |
...
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 69,773 | TypeScript | 🌊 The leading agent orchestration platform for Claude. Deploy intellig |
| [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) | 68,064 | Python | Compress tool outputs, logs, files, and RAG chunks before they reach t |
| [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) | 61,934 | Python | ⭐AI-driven public opinion & trend monitor with multi-platform aggregat |
| [upstash/context7](https://github.com/upstash/context7) | 61,407 | TypeScript | Context7 MCP Server -- Up-to-date code documentation for LLMs and AI c |
| [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 58,355 | TypeScript | Never stop coding. The free AI gateway — one endpoint, 160+ providers, |
...
| [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | 47,532 | Python | Ultra-lightweight, open-source, self-hosted personal AI agent framewor |
...
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | 46,724 | Python | CowAgent (chatgpt-on-wechat) 是基于大模型的超级AI助理，能主动思考和任务规划、访问操作系统和外部资源、创造和执 |
...
| [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) | 42,617 | TypeScript | Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS |
| [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) | 41,949 | TypeScript | A one-of-a-kind resume builder that keeps your privacy in mind. Comple |
| [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | 39,799 | Python | Agentic IM Chatbot infrastructure that integrates lots of IM platforms |
| [wshobson/agents](https://github.com/wshobson/agents) | 39,259 | Python | Multi-harness agentic plugin marketplace for Claude Code, Codex CLI, C |
...
| [tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) | 31,008 | Python | Local knowledge graph for Claude Code. Builds a persistent map of your |
| [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 29,943 | TypeScript | Composio powers 1000+ toolkits, tool search, context management, authe |
| [labring/FastGPT](https://github.com/labring/FastGPT) | 29,498 | TypeScript | FastGPT is a knowledge-based platform built on the LLMs, offers a comp |
| [oraios/serena](https://github.com/oraios/serena) | 28,639 | Python | A powerful coding agent toolkit providing semantic retrieval and editi |
| [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | 28,397 | TypeScript | ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized t |
| [yamadashy/repomix](https://github.com/yamadashy/repomix) | 28,120 | TypeScript | 📦 Repomix is a powerful tool that packs your entire repository into a  |
| [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) | 26,504 | Python |  |
...
| [TryCaspian/caspian-sdk](https://github.com/TryCaspian/caspian-sdk) | 934 | Python | One identity for your AI agent across Slack, Discord, Telegram, WhatsA |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) | 4,355 | Python | MCP server that interacts with Obsidian via the Obsidian rest API comm |
| [coddingtonbear/obsidian-local-rest-api](https://github.com/coddingtonbear/obsidian-local-rest-api) | 2,867 | TypeScript | A secure REST API and Model Context Protocol (MCP) server for your vau |
...
| [FradSer/mcp-server-apple-events](https://github.com/FradSer/mcp-server-apple-events) | 192 | TypeScript | MCP server providing native macOS integration with Apple Reminders and |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata) | 15,032 | TypeScript | OpenMetadata is a unified metadata platform for data discovery, data o |
...
| [microsoft/flint-chart](https://github.com/microsoft/flint-chart) | 4,053 | TypeScript | 🪄 Flint is a visualization language that lets AI agents reliably creat |
| [dagucloud/dagu](https://github.com/dagucloud/dagu) | 3,820 | Go | Lightweight, powerful workflow engine built in a single binary with We |
...
| [slothflowlabs/duckle](https://github.com/slothflowlabs/duckle) | 1,250 | Rust | Open-source self-hosted ETL and ELT tool on DuckDB. Low-code visual da |
...
| [artokun/comfyui-mcp](https://github.com/artokun/comfyui-mcp) | 701 | TypeScript | ComfyUI MCP server + Claude Code plugin — workflow execution, visualiz |
| [cohnen/mcp-google-ads](https://github.com/cohnen/mcp-google-ads) | 698 | Python | An MCP tool that connects Google Ads with Claude AI/Cursor and others, |
...
| [surendranb/google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp) | 236 | Python | Google Analytics 4 MCP Server for Claude, Cursor, Windsurf etc - Acces |
...
| [garethbeaumo/originlab-mcp](https://github.com/garethbeaumo/originlab-mcp) | 72 | Python | MCP Server for OriginLab  Control OriginLab with natural language thro |
...
| [mdwsk88/ms-365-21v-mcp-server](https://github.com/mdwsk88/ms-365-21v-mcp-server) | 54 | TypeScript | Policy-aware OAuth 2.1 MCP gateway for Microsoft 365 operated by 21Via |
...
| Project | ⭐ | Language | Description |
|---------|---:|:--------:|-------------|
| [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | 22,804 | TypeScript | A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8 |
| [xpzouying/xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | 15,550 | Go | MCP for xiaohongshu.com |
| [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) | 9,890 | Java | MCP Server for Ghidra |
| [golang/tools](https://github.com/golang/tools) | 7,898 | Go | [mirror] Go Tools |
| [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) | 6,215 | TypeScript | Model Context Protocol Server for Mobile Automation and Scraping (iOS, |
...
| [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) | 3,402 | Go | MCP server for Grafana |
...
| [rohitg00/awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit) | 2,570 | JavaScript | The most comprehensive toolkit for Claude Code -- 135 agents, 35 curat |
...
| [samanhappy/mcphub](https://github.com/samanhappy/mcphub) | 2,348 | TypeScript | A unified hub for centrally managing and dynamically orchestrating mul |
...
| [joshuayoes/ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) | 2,151 | JavaScript | MCP server for interacting with the iOS simulator |
| [neka-nat/freecad-mcp](https://github.com/neka-nat/freecad-mcp) | 1,946 | Python | FreeCAD MCP(Model Context Protocol) server |
| [figma/mcp-server-guide](https://github.com/figma/mcp-server-guide) | 1,935 | JavaScript | A guide on how to use the Figma MCP server |
...
| [svnscha/mcp-windbg](https://github.com/svnscha/mcp-windbg) | 1,550 | Python | Model Context Protocol for WinDBG |
...
| [WenXiaoWendy/cyberboss](https://github.com/WenXiaoWendy/cyberboss) | 1,346 | JavaScript | 一个接入微信的本地生活 Agent Bridge，让 Codex / Claude Code 拥有时间感、行踪感、随机唤醒和自主唤醒能力，用 |
...
| [ref-tools/ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) | 1,160 | TypeScript | Helping coding agents never make mistakes working with public or priva |
| [Mibayy/token-savior](https://github.com/Mibayy/token-savior) | 1,130 | Python | MCP server for Claude Code: 97% token savings on code navigation + per |
...
| [wilwaldon/Claude-Code-Frontend-Design-Toolkit](https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit) | 1,028 | - | Everything I've found that actually makes Claude Code output better-lo |
| [NoOne-hub/JSReverser-MCP](https://github.com/NoOne-hub/JSReverser-MCP) | 990 | TypeScript | JSReverser-MCP 是一个面向 JavaScript 逆向分析的 MCP 工具，专门用于帮助开发者在真实浏览器环境中高效定位前端核 |
...
<p align="center"><sub>✨ Auto-curated · 2026-08-30 20:11:39</sub></p>
